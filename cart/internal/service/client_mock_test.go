...
//go:generate minimock -i route256.ozon.ru/project/cart/internal/service.Client -o client_mock_test.go -n ClientMock -p service
...
type ClientMock struct {
	...
	funcGetProduct          func(ctx context.Context, skuID int64) (pp1 *entity.Product, err error)
...
func (mmGetProduct *mClientMockGetProduct) Expect(ctx context.Context, skuID int64) *mClientMockGetProduct {
	...
	mmGetProduct.defaultExpectation.params = &ClientMockGetProductParams{ctx, skuID}
...
func (mmGetProduct *mClientMockGetProduct) Inspect(f func(ctx context.Context, skuID int64)) *mClientMockGetProduct {
...
func (mmGetProduct *mClientMockGetProduct) Return(pp1 *entity.Product, err error) *ClientMock {
	if mmGetProduct.mock.funcGetProduct != nil {
		mmGetProduct.mock.t.Fatalf("ClientMock.GetProduct mock is already set by Set")
	}
...
func (mmGetProduct *mClientMockGetProduct) Set(f func(ctx context.Context, skuID int64) (pp1 *entity.Product, err error)) *ClientMock {
	if mmGetProduct.defaultExpectation != nil {
...
// Then helper
func (mmGetProduct *mClientMockGetProduct) When(ctx context.Context, skuID int64) *ClientMockGetProductExpectation {
	if mmGetProduct.mock.funcGetProduct != nil {
		mmGetProduct.mock.t.Fatalf("ClientMock.GetProduct mock is already set by Set")
	}
	...
	expectation := &ClientMockGetProductExpectation{
		...
		params: &ClientMockGetProductParams{ctx, skuID},
	}
...
func (e *ClientMockGetProductExpectation) Then(pp1 *entity.Product, err error) *ClientMock {
	e.results = &ClientMockGetProductResults{pp1, err}
	return e.mock
}

// GetProduct implements Client
func (mmGetProduct *ClientMock) GetProduct(ctx context.Context, skuID int64) (pp1 *entity.Product, err error) {
	...
	mm_params := ClientMockGetProductParams{ctx, skuID}
	...
	if mmGetProduct.GetProductMock.defaultExpectation != nil {
		...
		mm_got := ClientMockGetProductParams{ctx, skuID}
	...
	mmGetProduct.t.Fatalf("Unexpected call to ClientMock.GetProduct. %v %v", ctx, skuID)
	return
}
